...
public static class OneStepHMAC
{
    public static void DeriveKey(Span<byte> derivedKeyingMaterial, ReadOnlySpan<byte> sharedSecret, ReadOnlySpan<byte> salt, ReadOnlySpan<byte> fixedInfo, HashAlgorithmName hashAlgorithmName)
    {
